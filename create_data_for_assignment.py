...
def run(path_to_your_image, dir_name, zoom, corr):
    ...
    # path_to_your_image=sys.argv[1]
    zoom_out=zoom #Fraction of the image you want to keep.
    corruption=corr#Fraction of the pixels that you want to discard
